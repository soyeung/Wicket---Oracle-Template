        ...
        public UpdateListForm( final String pId , final DataStructure pDataStructure , final ListMetaData pListMetaData )
        {
            ...
            (
                new RefreshingView<ListDatum>( "DataList" )
                {
                    ...
                    {
                        RequiredTextField<String> itemCodeTextField = new RequiredTextField<String>( "code" );
                        itemCodeTextField.add( new AttributeModifier( "maxlength" , true , new Model<Integer>( listMetaData.getCodeMaxLength() ) ) );
                        itemCodeTextField.add( new LengthBetweenValidator( 1 , listMetaData.getCodeMaxLength() ) );
