prompt creating package body pk_delegate_user_role_mgr

create or replace package body app_user.pk_delegate_user_role_mgr
as
    ...
    end fn_get_delegate_user_roles;
    ...
    is
        ...
        c_procedure_name constant varchar2(30 char) := 'pr_update_delegate_user_roles';
    ...
    end pr_update_delegate_user_roles;
