prompt creating view v_list_ref_data

create or replace view app_data.v_list_ref_data
as
select
       rds.rds_id             rds_id
     ...
     , lrds.rds_id_sequence   rds_id_sequence
     , rds.rdt_code           rdt_code
  from
            app_data.v_ref_data_structure rds
       join app_data.list_ref_data        lrds on rds.rds_id = lrds.rds_id
  with
       read only
/