prompt creating package body app_refdata.pk_coded_list_mgr

create or replace package body app_refdata.pk_coded_list_mgr
as
    ...
    begin
        ...
        open
             v_data_set
         for
             app_refdata.pk_coded_list_sql.fn_get_data_sql( p_rds_id => p_rds_id )
           ;
    ...
    is
        ...
        v_sql_statements constant app_utility.tty_string := app_refdata.pk_coded_list_sql.fn_get_update_sql( p_rds_id => p_rds_id );
        v_lock_sql                varchar2( 32767 char ) := app_refdata.pk_coded_list_sql.fn_get_lock_sql  ( p_rds_id => p_rds_id );

        v_number_records_changed binary_integer := 0;
        ...
        begin
            ...
            loop
                ...
                v_number_records_changed := v_number_records_changed + sql%rowcount;
        ...
        begin
            ...
            if p_dataset.count != v_number_records_changed then
                ...
                ,   p_message           => p_dataset.count || ' records were submitted. ' || v_number_records_changed || ' were changed.'
                );
