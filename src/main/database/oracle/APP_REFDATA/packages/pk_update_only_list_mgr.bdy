prompt creating package body app_refdata.pk_update_only_list_mgr

create or replace package body app_refdata.pk_update_only_list_mgr
as
  ...
  c_package_name  constant varchar2( 30 char ) := $$plsql_unit;
    ...
    is
        ...
        c_sql      constant varchar2( 32767 char ) := app_refdata.pk_update_only_list_sql.fn_get_data_sql( p_rds_id => p_rds_id );
    ...
    is
        ...
        v_sql_statements constant app_utility.tty_string   := app_refdata.pk_update_only_list_sql.fn_get_update_sql( p_rds_id => p_rds_id );
        v_lock_sql                varchar2( 32767 char )   := app_refdata.pk_update_only_list_sql.fn_get_lock_sql  ( p_rds_id => p_rds_id );
